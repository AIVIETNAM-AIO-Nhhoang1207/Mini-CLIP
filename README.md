...
3. **Kích thước mô hình**: BERT to hơn DistilBERT, ViT cũng nặng hơn ResNet18. Việc model lớn đi kèm dataset nhỏ dễ dẫn đến hiện tượng khó học hoặc overfitting (đặc biệt trong quá trình Contrastive Learning).
